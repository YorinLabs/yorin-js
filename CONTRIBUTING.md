# Contributing to Yorin Analytics JavaScript SDK

Thank you for your interest in contributing to the Yorin Analytics JavaScript SDK! We welcome contributions from the community.
...
2. **Clone your fork** locally:
   ```bash
   git clone https://github.com/YOUR_USERNAME/yorin-js.git
   cd yorin-js
   ```
...
2. **Search Existing Issues**: Look through [existing issues](https://github.com/YorinLabs/yorin-js/issues) to see if your question has been addressed
3. **Report Bugs**: If you find a bug, please [open an issue](https://github.com/YorinLabs/yorin-js/issues/new) with:
...
1. [Open an issue](https://github.com/YorinLabs/yorin-js/issues/new) with the "enhancement" label
